  ...
  <div class="full-size-space-between">
    <div class="full-size-space-between__row">
          ...
          <vs-table ref="table" striped>
            <template #thead>
              <vs-tr>
                ...
                <vs-th sort @click="localApplications = $vs.sortData($event, localApplications, 'CreatedAt')">
                  CreatedAt
                </vs-th>
                <vs-th sort @click="localApplications = $vs.sortData($event, localApplications, 'UpdatedAt')">
                  UpdatedAt
                </vs-th>
                <vs-th />
              </vs-tr>
            ...
            <template #tbody>
              <vs-tr :key="tr.ID" v-for="tr in localApplications" :data="tr">
                <vs-td>
                  {{ tr.BundleId }}
                </vs-td>
                <vs-td>
      ...
      <MakeApplication
        ...
        @success="payload => localApplications.push(payload)"
      />
    </div>

    <div v-if="localApplications.length" class="full-size-space-between__row">
      <div class="statistics">
        Записей: {{ localApplications.length }}
      </div>
    </div>
  </div>
</template>
